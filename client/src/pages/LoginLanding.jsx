  ...
  const portalOptions = [
    {
      ...
      description: "Sign in to manage the yourself",
      icon: UserIcon
    }
  ]
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="mb-10 text-center md:text-left">
          <h2 className="text-3xl font-medium text-slate-900 tracking-tight md-3">Welcome Back</h2>
        ...
        {/*Footer*/}
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>&copy; {new Date().getFullYear()} Gaurang Srivastava. All rights reserved</p>
          </div>
