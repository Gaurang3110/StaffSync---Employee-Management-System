        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              required className="border border-slate-300 focus:ring-2 focus:ring-blue-500 focus:outline-none py-2 px-3 rounded-lg"
          ...
          <button type="submit" disabled={loading} className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:bg-blue-300 transition-all duration-200 shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center" >
